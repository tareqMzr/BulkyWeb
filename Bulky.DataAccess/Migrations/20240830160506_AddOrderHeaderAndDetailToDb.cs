    ...
    public partial class AddOrderHeaderAndDetailToDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderHeader_Id = table.Column<int>(type: "int", nullable: false)
                    ...
                    PaymetStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrackingNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Carrier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymetDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PaymetDueDate = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderHeader", x => x.OrderHeader_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetail", x => x.OrderDetails_Id);
                    table.ForeignKey(
